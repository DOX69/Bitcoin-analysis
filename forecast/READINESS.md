...
Le propriétaire a demandé de remplacer l'automatisation Codex initiale par le cron Railway Development et de passer à 07:00 Europe/Paris. La [procédure Development](DEVELOPMENT_RESEARCH.md) décrit le worker, les buckets, la reprise et le budget. Le suivi Codex doit être supprimé après vérification du traitement cloud pour éviter deux collecteurs. La commande locale reste disponible pour audit ; aucun rattrapage ne doit antidater une émission.
